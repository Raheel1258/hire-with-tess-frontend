...
export default function CardComponent({ heading, subheading, icon }: CardProps) {
  return (
    <div
      className="bg-white rounded-xl p-4 flex flex-col gap-4 w-full max-w-full h-auto border sm:flex-row sm:items-center sm:justify-between sm:gap-6 overflow-hidden"
    >
      <div className="flex flex-col gap-y-2 flex-shrink-0">
        ...
        <CardDescription className="text-base pl-3 text-black font-semibold truncate mt-2">
          {subheading}
        </CardDescription>
      </div>
    </div>
